...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SentencePiece_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0cc836cc-86cb-5b0e-b290-caf6c31794d8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SentencePiece", artifacts_toml) for e in artifacts["SentencePiece"]]
...
if best_platform === nothing
    @debug("Unable to load SentencePiece; unsupported platform $(triplet(platform_key_abi()))")
else
