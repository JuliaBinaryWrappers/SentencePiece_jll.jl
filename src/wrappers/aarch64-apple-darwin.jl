# Autogenerated wrapper script for SentencePiece_jll for aarch64-apple-darwin
...
JLLWrappers.@declare_library_product(libsentencepiece, "@rpath/libsentencepiece.0.dylib")
JLLWrappers.@declare_library_product(libsentencepiece_train, "@rpath/libsentencepiece_train.0.dylib")
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libsentencepiece,
        "lib/libsentencepiece.0.0.0.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libsentencepiece_train,
        "lib/libsentencepiece_train.0.0.0.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
