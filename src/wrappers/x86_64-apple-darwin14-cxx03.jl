# Autogenerated wrapper script for SentencePiece_jll for x86_64-apple-darwin14-cxx03
...
const libsentencepiece_splitpath = ["lib", "libsentencepiece.0.0.0.dylib"]
...
const libsentencepiece = "@rpath/libsentencepiece.0.dylib"


# Relative path to `libsentencepiece_train`
const libsentencepiece_train_splitpath = ["lib", "libsentencepiece_train.0.0.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libsentencepiece_train = "@rpath/libsentencepiece_train.0.dylib"
